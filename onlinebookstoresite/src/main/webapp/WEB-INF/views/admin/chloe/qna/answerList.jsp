	...
	<div id="listPaging">
		<c:choose>
			<c:when test="${pu.startPageNum > 3 }">
				<a
					href="${pageContext.request.contextPath }/answerList?pageNum=${pu.startPageNum - 1}">
		...
		<c:forEach var="i" begin="${pu.startPageNum }" end="${pu.endPageNum }">
			<c:choose>
				<c:when test="${i == pu.pageNum }">
					<a
						href="${pageContext.request.contextPath }/answerList?pageNum=${i}">
		...
		<c:choose>
			<c:when test="${pu.totalPageCnt > pu.endPageNum }">
				<a
					href="${pageContext.request.contextPath }/answerList?pageNum=${pu.endPageNum + 1}">
