		...
		<table class="booksSearchTable table">
			<tr>
				...
				<td>
					...
					<input type="text" name="infoKeyword" value="${infoKeyword }" size="30"></td>
		...
		<c:forEach var="i" begin="${pu.startPageNum }" end="${pu.endPageNum }">
			<c:choose>
				<c:when test="${i == pu.pageNum }">
					<a
						href="${pageContext.request.contextPath }/booksList?pageNum=${i}&infoField=${infoField}&infoKeyword=${infoKeyword}&priceKeyword1=${priceKeyword1}&priceKeyword2=${priceKeyword2}&countKeyword1=${countKeyword1}&countKeyword2=${countKeyword2}&dateKeyword1=${dateKeyword1}&dateKeyword2=${dateKeyword2}">
