...
<table class="table searchbox">
	...
	<tr>
		...
		<td><input type="checkbox" name="oType" value="ototal"
			id="ototal"><label for="ototal"> &nbsp;전체
				&nbsp;&nbsp;</label> <input type="checkbox" name="oType" value="oapply"
			id="oapply"><label for="oapply"> &nbsp;신청
				&nbsp;&nbsp;</label> <input type="checkbox" name="oType" value="ocomplete"
			id="ocomplete"><label for="ocomplete"> &nbsp;완료
				&nbsp;&nbsp;</label></td>
	</tr>
	<tr>
		<th class="table-active">회원 / 비회원</th>
		<td><input type="radio" name="mType" value="mtotal" id="mtotal"><label
			for="mtotal"> &nbsp;전체 &nbsp;&nbsp;</label> <input type="radio"
			name="mType" value="member" id="member"><label for="member">
				&nbsp;회원 &nbsp;&nbsp;</label> <input type="radio" name="mType"
			value="nonemember" id="nonemember"><label for="nonemember">
				&nbsp;비회원 &nbsp;&nbsp;</label></td>
	</tr>
	<tr>
